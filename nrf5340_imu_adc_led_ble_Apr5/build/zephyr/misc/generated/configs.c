...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_CONN_PARAM_UPDATE_TIMEOUT, 300);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_SENSOR_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANALOG_SENSOR_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_SENSOR_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_SENSOR_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_NUS_CMD_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BLE_NUS_CMD_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_LED_BLE_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_IMU_LED_BLE_LOG_LEVEL, 3);
